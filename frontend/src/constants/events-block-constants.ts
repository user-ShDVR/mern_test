...
export const featuresInEventsBlock = [
  ...
  {
    key: 1,
    text: "Выбирай из 150+ сортов разливных напитков",
  },
  {
    key: 2,
    text: "Рыба на любой вкус и огромный выбор снэков",
  },
  {
    key: 3,
    text: "1000+ товаров для дома и отдыха на природе",
  },
];
